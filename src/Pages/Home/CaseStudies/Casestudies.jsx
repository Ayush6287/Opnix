...
const Casestudies = () => {
  return (
    <div className='h-full p-2  items-center  flex flex-col  text-white  bg-emerald-950 sm:p-2 sm:items-center   sm:flex sm:flex-col'>
           <CasestudyHero />
           <CasestudyPara />
        <div className='grid grid-row-3 gap-8  sm:grid sm:grid-cols-3   w-6/7'>
